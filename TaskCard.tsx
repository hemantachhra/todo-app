        ...
        <div className="flex gap-2">
          {!showConfirm ? (
            <>
              ...
              <button onClick={() => onFocus(task)} title="Enter Focus Mode" className="w-12 h-12 rounded-xl bg-slate-950 border border-blue-500/20 flex items-center justify-center text-blue-400 text-xl">🎯</button>
              <button onClick={() => onEdit(task)} className="w-12 h-12 rounded-xl bg-slate-950 border border-white/5 flex items-center justify-center text-slate-400 text-[10px] font-black uppercase">Edit</button>
